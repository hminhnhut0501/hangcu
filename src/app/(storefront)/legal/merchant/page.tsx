export default function MerchantReadinessPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16 prose prose-slate">
      <h1>Merchant Readiness / Sẵn sàng cho cổng thanh toán</h1>
      <p>
        This page summarizes the business model for payment reviewers: digital software licenses
        delivered electronically after payment confirmation.
      </p>
      <p>
        Trang này tóm tắt mô hình kinh doanh cho bộ phận duyệt thanh toán: license phần mềm số
        được giao điện tử sau khi thanh toán thành công.
      </p>
